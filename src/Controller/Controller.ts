...
import { touchActionEventName, TouchController, type DirectionObject } from './TouchController'
import type { DirectionKey } from '../types'

// Action keys type
type ActionKey = DirectionKey | 'space' | 'other'
...
export class Controller {
  ...
  setup(stage: Container) {
    ...
    if (gameConfig.isTouchDevice) {
      ...
      this.touchController.setup(stage)
      this.touchController.on(touchActionEventName, (actionObject: DirectionObject) => {
        this.keys['up'].pressed = actionObject['up']
        this.keys['down'].pressed = actionObject['down']
        this.keys['left'].pressed = actionObject['left']
        this.keys['right'].pressed = actionObject['right']
      })
    }
  }
